...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2025 at 09:32 AM
...
CREATE TABLE `orders` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `order_type` enum('dine-in','take-out','pickup') NOT NULL,
...
CREATE TABLE `refunds` (
  ...
  `status` enum('requested','approved','declined','completed') DEFAULT 'requested',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `store_settings` (
  ...
  `opening_time` time DEFAULT '16:00:00',
  `closing_time` time DEFAULT '22:00:00',
  `closed_day` enum('sunday','none') DEFAULT 'sunday',
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `feedback`
  ...
  ADD CONSTRAINT `feedback_ibfk_2` FOREIGN KEY (`menu_item_id`) REFERENCES `menu_items` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `feedback_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `refunds`
  ...
  ADD CONSTRAINT `refunds_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
